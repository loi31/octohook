...
local library = {
    ...
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'Octo';
    gamename = startupArgs.gamename or 'Universal'; -- cheatname falan 
    fileext = startupArgs.fileext or '.txt';
    domain = startupArgs.domain or 'hook';
}
...
function library:init()
    ...
    self:SetTheme(library.themes[1].theme); --default theme
    self:SetOpen(true);
    self.hasInit = true
            ...
            theme_section:AddList({text = "Presets", flag = "preset_theme", values = theme_strings, callback = function(new_theme)
                ...
                for _,v in next, library.themes do
                    if v.name == new_theme then
                        ...
                        --library:SendNotification("Theme Set To "..v.theme)
                        break;
                    end;
                end;
                setByPreset = false
